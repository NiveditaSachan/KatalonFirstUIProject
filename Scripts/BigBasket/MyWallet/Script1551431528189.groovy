...
WebUI.openBrowser('')
	...
	String FromDate=WebUiCommonHelper.findWebElement(findTestObject('BigBasket/MyWallet/WalletActivity/MyWallet_WalletActivity/input_From_datePicker'),15).getAttribute("value")
	
	println("FromDate is : " + FromDate)
	
	String ToDate=WebUiCommonHelper.findWebElement(findTestObject('BigBasket/MyWallet/WalletActivity/MyWallet_WalletActivity/input_To_datePicker'), 15).getAttribute("value")
	
	println("ToDate is : " + ToDate)
	
	WebUI.click(findTestObject('BigBasket/MyWallet/WalletActivity/MyWallet_WalletActivity/input_From_datePicker'))
	
	WebUI.click(findTestObject('BigBasket/MyWallet/WalletActivity/MyWallet_WalletActivity/a_PickDate_Row1_Colomn6_Fri1st'))

	WebUI.click(findTestObject('BigBasket/MyWallet/WalletActivity/MyWallet_WalletActivity/btn_SHOW ACTIVITY'))
		
	List<WebElement> HeaderRow=WebUiCommonHelper.findWebElements(findTestObject('Object Repository/BigBasket/MyWallet/WalletActivity/MyWallet_WalletActivity/WalletActivity_RowHeader'), 15)
	
	if(HeaderRow.size()>0){
		
		List<WebElement> Row1Data=WebUiCommonHelper.findWebElements(findTestObject('BigBasket/MyWallet/WalletActivity/MyWallet_WalletActivity/WalletActivity_Row1Data'), 15)
